...
static const onsigned int borderalpha = OPAQUE;

/* custom colors */
static const char col_black[]       = "#0F0E11";
static const char col_gray[]        = "#B8B8BC";
...
/* tagging */
static const char *tags[] = { "first", "second", "third" };
